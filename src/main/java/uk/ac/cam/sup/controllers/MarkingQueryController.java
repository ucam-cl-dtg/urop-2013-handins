...
public class MarkingQueryController {
     ...
     */
    @GET
    @Path("/bin/{binId}/student/{studentCrsId}/question/{questionId}/download")
    @Produces("application/pdf")
     ...
     */
    @GET
    @Path("/bin/{binId}/question/{questionId}/student/{studentCrsId}/download")
    @Produces("application/pdf")
